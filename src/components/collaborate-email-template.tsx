...
export const CollaborateEmailTemplate = ({ firstName }: EmailTemplateProps) => {
  return (
    <Html>
        ...
        >
          ...
          >
            ...
            >
              ...
              collaborating with Kaly&apos;s House. We&apos;re excited to learn
              more about your vision and how we might work together.
            </Text>
            ...
            >
              <p>
                We&apos;re happy to let you know that we have successfully
                received your submission. Our team will review the details you
                provided to understand the potential fit and opportunities for
                partnership.
              </p>
              <ul style={{ paddingLeft: "20px", marginBottom: "16px" }}>
                <li>
                  1. Our team team will go through your submission carefully.
                </li>
                <li>
                  2. If your goals align with our current initiatives,
                  we&apos;ll reach out to continue the conversation.
                </li>
                <li>3. You can expect an update from us within a few days.</li>
              </ul>
            </Section>
            ...
            >
              We appreciate your interest in collaborating with us and look
              forward to exploring the possibilities.
            </Text>
